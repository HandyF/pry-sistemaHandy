...
class mantipodocumento
{
    ...
    public function guardar($descrip)
    {
        ...
        $consulta = "INSERT INTO ttipo_documento (ID_TIPO_DOCUMENTO, DESCRIPCION) VALUES (null, '" . $descrip . "')";
    ...
    {
        include 'controlador/conecta.php';
        $consulta = "UPDATE ttipo_documento SET DESCRIPCION = '" . $descrip . "' WHERE ID_TIPO_DOCUMENTO=" . $id;
        $res      = $mysqli->query($consulta);
        if ($res) {
            return true;
        } else {
    ...
    public function elimina($id)
    {
        ...
        $consulta = "DELETE FROM ttipo_documento WHERE ID_TIPO_DOCUMENTO =" . $id;
        $res      = $mysqli->query($consulta);
        if ($res) {
            return true;
        } else {
