...

{
    ...
    {
        include 'controlador/conecta.php';
        $consulta = "UPDATE tasignacion_bodega_producto SET ID_BODEGA='" . $Bodega . "', ID_PRODUCTO='" . $Producto . "', FECHA_HORA_ASIG=now(), CANTIDAD_PRODUCTO='" . $cantidadProducto . "' , OBSERVACION='" . $observacion . "' WHERE ID_BODEGA=" . $id;
        $res      = $mysqli->query($consulta);
        if ($res) {
            return true;
        } else {
