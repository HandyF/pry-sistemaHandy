...
class mantipoproducto
{
    ...
    public function guardar($descrip)
    {
        ...
        $consulta = "INSERT INTO ttipo_producto (ID_TIPO_PRODUCTO, DESCRIPCION) VALUES (null, '" . $descrip . "')";
    ...
    {
        include 'controlador/conecta.php';
        $consulta = "UPDATE ttipo_producto SET DESCRIPCION = '" . $descrip . "' WHERE ID_TIPO_PRODUCTO=" . $id;
        $res      = $mysqli->query($consulta);
        if ($res) {
            return true;
        } else {
    ...
    public function elimina($id)
    {
        ...
        $consulta = "DELETE FROM ttipo_producto WHERE ID_TIPO_PRODUCTO =" . $id;
        $res      = $mysqli->query($consulta);
        if ($res) {
            return true;
        } else {
