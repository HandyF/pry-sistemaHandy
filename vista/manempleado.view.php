...
?>
                     ...
                     <tr>
                      ...
                      <tr>
                        <th>Apellidos &nbsp;</th>
                        <td><input type="text" name="apellidos" id="apellidos" maxlength="50" required placeholder="Digite Apellidos" onkeypress="return soloLetras(event)" onblur="limpia()"  class="form-control" onpaste="return false"></td>
                    </tr>
    ...
    <i id="result"></i> <br/></td>
                     ...
                     <tr>
                        ...
                        <td><input type="text" name="direccion" id="direccion" maxlength="50"  required placeholder="Digite direccion" class="form-control" onpaste="return false"></td>
                    </tr>
                     ...
                     <tr>
                        ...
                        <td><input type="email" name="mail" id="mail" maxlength="50" required placeholder="contacto@correo.com" class="form-control" onpaste="return false"></td>
                    </tr>
...
while ($row = mysqli_fetch_array($rs)) {
    ?>
                            <tr>
                                ...
                                <td><button class="btn btn-success" onclick="moverEmpleado(<?php echo $row['Identificador'] ?>,'<?php echo $row['ID_TIPO_EMPLEADO'] ?>', '<?php echo $row['RUT_EMPLEADO'] ?>', '<?php echo $row['NOMBRES_EMPLEADO'] ?>','<?php echo $row['APELLIDOS_EMPLEADO'] ?>', '<?php echo $row['FECHA_NACIMIENTO'] ?>', '<?php echo $row['DIRECCION_EMPLEADO'] ?>', '<?php echo $row['FONO_EMPLEADO'] ?>', '<?php echo $row['EMAIL_EMPLEADO'] ?>')">Modificar <span class="glyphicon glyphicon-refresh"></span></button></td>
